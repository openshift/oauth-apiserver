...
${GOPATH}/bin/defaulter-gen $(codegen::join_with_space , "${ALL_FQ_APIS[@]}") --extra-peer-dirs $(codegen::join , "${ALL_PEERS[@]}") --output-file zz_generated.defaults.go --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt --v=8 "$@"
