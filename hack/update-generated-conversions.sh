...
${GOPATH}/bin/conversion-gen $(codegen::join_with_space , "${ALL_FQ_APIS[@]}") --extra-peer-dirs $(codegen::join , "${ALL_PEERS[@]}") --output-file zz_generated.conversion.go --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt --v=8 "$@"
