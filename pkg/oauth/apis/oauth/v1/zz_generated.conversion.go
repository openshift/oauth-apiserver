...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.UserOAuthAccessToken)(nil), (*oauth.UserOAuthAccessToken)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_UserOAuthAccessToken_To_oauth_UserOAuthAccessToken(a.(*v1.UserOAuthAccessToken), b.(*oauth.UserOAuthAccessToken), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*oauth.UserOAuthAccessToken)(nil), (*v1.UserOAuthAccessToken)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_oauth_UserOAuthAccessToken_To_v1_UserOAuthAccessToken(a.(*oauth.UserOAuthAccessToken), b.(*v1.UserOAuthAccessToken), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*v1.UserOAuthAccessTokenList)(nil), (*oauth.UserOAuthAccessTokenList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_UserOAuthAccessTokenList_To_oauth_UserOAuthAccessTokenList(a.(*v1.UserOAuthAccessTokenList), b.(*oauth.UserOAuthAccessTokenList), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*oauth.UserOAuthAccessTokenList)(nil), (*v1.UserOAuthAccessTokenList)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_oauth_UserOAuthAccessTokenList_To_v1_UserOAuthAccessTokenList(a.(*oauth.UserOAuthAccessTokenList), b.(*v1.UserOAuthAccessTokenList), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1_UserOAuthAccessToken_To_oauth_UserOAuthAccessToken(in *v1.UserOAuthAccessToken, out *oauth.UserOAuthAccessToken, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ClientName = in.ClientName
	out.ExpiresIn = in.ExpiresIn
	out.Scopes = *(*[]string)(unsafe.Pointer(&in.Scopes))
...
func Convert_v1_UserOAuthAccessToken_To_oauth_UserOAuthAccessToken(in *v1.UserOAuthAccessToken, out *oauth.UserOAuthAccessToken, s conversion.Scope) error {
	return autoConvert_v1_UserOAuthAccessToken_To_oauth_UserOAuthAccessToken(in, out, s)
}

func autoConvert_oauth_UserOAuthAccessToken_To_v1_UserOAuthAccessToken(in *oauth.UserOAuthAccessToken, out *v1.UserOAuthAccessToken, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	out.ClientName = in.ClientName
	out.ExpiresIn = in.ExpiresIn
	out.Scopes = *(*[]string)(unsafe.Pointer(&in.Scopes))
...
func Convert_oauth_UserOAuthAccessToken_To_v1_UserOAuthAccessToken(in *oauth.UserOAuthAccessToken, out *v1.UserOAuthAccessToken, s conversion.Scope) error {
	return autoConvert_oauth_UserOAuthAccessToken_To_v1_UserOAuthAccessToken(in, out, s)
}

func autoConvert_v1_UserOAuthAccessTokenList_To_oauth_UserOAuthAccessTokenList(in *v1.UserOAuthAccessTokenList, out *oauth.UserOAuthAccessTokenList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
...
func Convert_v1_UserOAuthAccessTokenList_To_oauth_UserOAuthAccessTokenList(in *v1.UserOAuthAccessTokenList, out *oauth.UserOAuthAccessTokenList, s conversion.Scope) error {
	return autoConvert_v1_UserOAuthAccessTokenList_To_oauth_UserOAuthAccessTokenList(in, out, s)
}

func autoConvert_oauth_UserOAuthAccessTokenList_To_v1_UserOAuthAccessTokenList(in *oauth.UserOAuthAccessTokenList, out *v1.UserOAuthAccessTokenList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]v1.UserOAuthAccessToken)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_oauth_UserOAuthAccessTokenList_To_v1_UserOAuthAccessTokenList is an autogenerated conversion function.
func Convert_oauth_UserOAuthAccessTokenList_To_v1_UserOAuthAccessTokenList(in *oauth.UserOAuthAccessTokenList, out *v1.UserOAuthAccessTokenList, s conversion.Scope) error {
