...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*Authenticator)(nil), (*authentication.Authenticator)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_Authenticator_To_authentication_Authenticator(a.(*Authenticator), b.(*authentication.Authenticator), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*authentication.Authenticator)(nil), (*Authenticator)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_authentication_Authenticator_To_v1alpha1_Authenticator(a.(*authentication.Authenticator), b.(*Authenticator), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_AuthenticationConfiguration_To_authentication_AuthenticationConfiguration(in *AuthenticationConfiguration, out *authentication.AuthenticationConfiguration, s conversion.Scope) error {
	out.JWT = *(*[]authentication.Authenticator)(unsafe.Pointer(&in.JWT))
	return nil
}
...
func autoConvert_authentication_AuthenticationConfiguration_To_v1alpha1_AuthenticationConfiguration(in *authentication.AuthenticationConfiguration, out *AuthenticationConfiguration, s conversion.Scope) error {
	out.JWT = *(*[]Authenticator)(unsafe.Pointer(&in.JWT))
	return nil
}
...
func autoConvert_v1alpha1_Authenticator_To_authentication_Authenticator(in *Authenticator, out *authentication.Authenticator, s conversion.Scope) error {
...
// Convert_v1alpha1_Authenticator_To_authentication_Authenticator is an autogenerated conversion function.
func Convert_v1alpha1_Authenticator_To_authentication_Authenticator(in *Authenticator, out *authentication.Authenticator, s conversion.Scope) error {
	return autoConvert_v1alpha1_Authenticator_To_authentication_Authenticator(in, out, s)
}

func autoConvert_authentication_Authenticator_To_v1alpha1_Authenticator(in *authentication.Authenticator, out *Authenticator, s conversion.Scope) error {
...
// Convert_authentication_Authenticator_To_v1alpha1_Authenticator is an autogenerated conversion function.
func Convert_authentication_Authenticator_To_v1alpha1_Authenticator(in *authentication.Authenticator, out *Authenticator, s conversion.Scope) error {
	return autoConvert_authentication_Authenticator_To_v1alpha1_Authenticator(in, out, s)
}
...
func autoConvert_v1alpha1_Issuer_To_authentication_Issuer(in *Issuer, out *authentication.Issuer, s conversion.Scope) error {
	out.URL = in.URL
	out.DiscoveryURL = (*string)(unsafe.Pointer(in.DiscoveryURL))
