...
replace (
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20231102175234-ca80b99425ce // points to openshift-apiserver-4.13-kubernetes-1.26.10
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.27.0-alpha.0.0.20240206045517-8f8514080eae
