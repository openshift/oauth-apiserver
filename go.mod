...
require (
	...
	k8s.io/kube-aggregator v0.23.12
...
replace (
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20221018202407-f0880417f61a // points to openshift-apiserver-4.10-kubernetes-1.23.12
