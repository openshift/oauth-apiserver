...
require (
	...
	github.com/openshift/api release-4.10
	github.com/openshift/apiserver-library-go release-4.10
	github.com/openshift/build-machinery-go release-4.10
	github.com/openshift/client-go release-4.10
	github.com/openshift/library-go release-4.10
...
replace (
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver openshift-apiserver-4.10-kubernetes-1.23.1
