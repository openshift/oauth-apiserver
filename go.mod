...
replace (
	...
	// k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20240112180301-bc101dc8b952 // points to openshift-apiserver-4.14-kubernetes-1.27.7
	k8s.io/apiserver => github.com/everettraven/openshift-kubernetes-apiserver v0.0.0-20260204184445-9db58893b64b
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v0.0.0-20240123031621-28ed2d70d51c
