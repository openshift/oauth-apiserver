...
require (
	...
	github.com/openshift/api v0.0.0-20260713093438-539606696dfb
	...
	github.com/openshift/library-go v0.0.0-20260714195535-84bc6054e9a0
...
replace (
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20260724190151-8aa3459a8bba // points to openshift-apiserver-4.22-kubernetes-1.35.2
